...
import { FormInstance } from '../../components/form/src/types/types';
import { ref } from 'vue';
...
const dialogCancel = (form: FormInstance) => {
  console.log('cancel', form);
  visible.value = false;
};
const dialogConfirm = (form: FormInstance) => {
  console.log('Confirm', form);
  let validate = form.validate();
  let model = form.getFormData();
  console.log(model);
  (validate as any)((valid: any) => {
    if (valid) {
  ...
  <div>
    ...
    >
      <template #footer="{form}">
        <el-button @click="dialogCancel(form)">Cancel</el-button>
        <el-button type="primary" @click="dialogConfirm(form)">Confirm</el-button>
      </template>
      <template #uploadArea>
